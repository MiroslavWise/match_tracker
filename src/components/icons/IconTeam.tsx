export default () => (
  <svg width="48" height="49" viewBox="0 0 48 49" fill="none" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
    <path
    ...
    />
    <defs>
      <linearGradient id="paint0_linear_72_663" x1="24" y1="0.5" x2="24" y2="48.5" gradientUnits="userSpaceOnUse">
        <stop stop-color="#CF1C51" />
        <stop offset="1" stop-color="#AF1947" />
      </linearGradient>
      <linearGradient id="paint1_linear_72_663" x1="24" y1="4.5" x2="24" y2="44.5" gradientUnits="userSpaceOnUse">
        <stop stop-color="#FEE3A2" />
        <stop offset="1" stop-color="#F2A768" />
      </linearGradient>
      <linearGradient id="paint2_linear_72_663" x1="24" y1="30.5" x2="24" y2="32.5" gradientUnits="userSpaceOnUse">
        <stop stop-color="#FEE3A2" />
        <stop offset="1" stop-color="#F2A768" />
      </linearGradient>
      <linearGradient id="paint3_linear_72_663" x1="24" y1="14.5" x2="24" y2="28.5" gradientUnits="userSpaceOnUse">
        <stop stop-color="#FEE3A2" />
        <stop offset="1" stop-color="#F2A768" />
      </linearGradient>
    </defs>
